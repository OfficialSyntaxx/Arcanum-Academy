...
export function createMiniForestCharacterLoader(): GLTFLoader {
  ...
  manager.setURLModifier((url) => (url.endsWith('Textures/colormap.png') ? avatarPaletteUrl : url));
